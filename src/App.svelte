...
<div
  ...
  data-theme={$dark_mode ? "dracula" : "cupcake"}
>
  ...
  <label
    class="swap swap-rotate fixed top-3 right-3 text-base-content bg-base-100 rounded-lg p-2 border-2 border-accent"
  >
    <input type="checkbox" bind:checked={$dark_mode} />
    <svg
